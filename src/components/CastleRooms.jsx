...
export default function CastleRooms() {
    ...
    // debug
    console.log(
        'CastleRooms มองเห็น reply เป็น:',
        reply,
        '  | questioon?: ',
        question,
    )
    ...
    return (
        <div className="container mx-auto py-10 gap-y-4 flex flex-col justify-center items-center bg-gray-800 text-white rounded-lg w-full">
